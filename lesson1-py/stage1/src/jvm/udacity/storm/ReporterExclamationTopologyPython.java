 ...
 *
 */
public class ReporterExclamationTopologyPython {

  /**
   * A bolt that adds the exclamation marks '!!!' to word
   */
  public static class ExclamationBoltJava extends BaseRichBolt
  {
  ...
  public static class ExclamationBoltPython extends ShellBolt implements IRichBolt
  {
    // To output tuples from this bolt to the next stage bolts, if any
    OutputCollector _collector;

    public ExclamationBoltPython()
    {
	super("python", "exclamationbolt.py");
    }
  ...
  public static void main(String[] args) throws Exception
  {
    ...
    builder.setBolt("exclaim1", new ExclamationBoltPython(), 1).shuffleGrouping("word");

    // attach another exclamation bolt to the topology - parallelism of 2
    builder.setBolt("exclaim2", new ExclamationBoltJava(), 2).shuffleGrouping("exclaim1");
