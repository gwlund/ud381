...
public class FivesLundTestSpout extends BaseRichSpout
{
...
//		//TODO: Emit located-values
		//System.out.println("Emitting: " + values.length + " values");
	...
	public void declareOutputFields(OutputFieldsDeclarer declarer) 
	{
		...
		//Don't use default stream
		//declarer.declare(locatedFields);
